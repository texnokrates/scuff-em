...
/***************************************************************/
/* Figure out which of the various regions in the geometry are */
/* the ultimate origin of the incident wave and the ultimate   */
/* destination of the transmitted wave.                        */
/***************************************************************/
