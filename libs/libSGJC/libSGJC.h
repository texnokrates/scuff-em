 ...
 *
 * (Minor modifications contributed by Homer Reid, 2009--2013)
 *
...
/***************************************************************/
/* wrappers with old-style calling convention provided for     */
/* backward compatibility                                      */
/***************************************************************/
typedef void (*oldintegrand) (unsigned ndim, const double *x, void *,
                              unsigned fdim, double *fval);
